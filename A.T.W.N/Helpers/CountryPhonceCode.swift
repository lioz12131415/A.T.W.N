...
class CountryPhonceCode: NSObject {
    ...
    static func getCountryPhoneCode(countryPhoneCode: String) -> String {
        return countryDictionary[countryPhoneCode] ?? ""
    }
}
